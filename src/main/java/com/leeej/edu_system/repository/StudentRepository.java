package com.leeej.edu_system.repository;
...
public class StudentRepository {
    ...
    public int update(Student student) {
        return jdbcTemplate.update(
                "UPDATE student SET name = ?, score = ?, teacher_id = ? " +
                        " WHERE id = ? ", student.getName(), student.getScore(), student.getTeacherId(), student.getId()
        );
    }
